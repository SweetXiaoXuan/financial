...
import cn.lv.jewelry.activity.daoBean.FinancialRecords;
 ...
 */
@Component
public class FinancialRecordsDao extends BasicDao<FinancialRecords>  {
    @Bean
    public FinancialRecordsDao activityAttenceDao() {
        return new FinancialRecordsDao();
    }

    private final static Logger logger = LoggerFactory.getLogger(FinancialRecordsDao.class);
